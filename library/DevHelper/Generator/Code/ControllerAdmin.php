...
class DevHelper_Generator_Code_ControllerAdmin {
	public static function generate(array $addOn, DevHelper_Config_Base $config, array $dataClass, array $info) {
		...
		$modelGetFunctionName = DevHelper_Generator_Code_Model::generateGetDataFunctionName($addOn, $config, $dataClass);
		$modelCountFunctionName = DevHelper_Generator_Code_Model::generateCountDataFunctionName($addOn, $config, $dataClass);
...
class {$info['controller']}_Generated extends XenForo_ControllerAdmin_Abstract {
	...
	public function actionIndex() {
		\${$variableName}Model = \$this->_get{$dataClass['camelCase']}Model();
